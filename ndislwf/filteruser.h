...
#define IOCTL_FILTER_GET_PACKET             _NDIS_CONTROL_CODE(15, METHOD_BUFFERED)
#define IOCTL_FILTER_SET_MUTATED_PACKET     _NDIS_CONTROL_CODE(16, METHOD_BUFFERED)
#define IOCTL_FILTER_SET_PACKET_UNMUTATED   _NDIS_CONTROL_CODE(17, METHOD_BUFFERED)
